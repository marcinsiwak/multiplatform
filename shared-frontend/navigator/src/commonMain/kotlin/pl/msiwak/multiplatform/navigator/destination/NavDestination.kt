...
import athletetrack.shared_frontend.commonresources.generated.resources.ic_settings
import athletetrack.shared_frontend.commonresources.generated.resources.ic_workout
import athletetrack.shared_frontend.commonresources.generated.resources.settings
import athletetrack.shared_frontend.commonresources.generated.resources.summary
...
sealed class NavDestination(val route: String) {
    ...
    sealed class AdminPanelDestination(route: String) : NavDestination(route) {
        object NavAdminPanelGraphDestination : AdminPanelDestination("admin_panel_graph")
        object NavAdminPanelScreen : AdminPanelDestination(ADMIN_PANEL_SCREEN_ROUTE)
    }
}
