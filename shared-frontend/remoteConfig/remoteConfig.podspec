Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/remoteConfig.framework') || Dir.empty?('build/cocoapods/framework/remoteConfig.framework')
        ...
        Kotlin framework 'remoteConfig' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :shared-frontend:remoteConfig:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':shared-frontend:remoteConfig',
